 ...
 * @author wiwat
 */
public class GUICrawler extends javax.swing.JFrame {

    /**
     * Creates new form GUICrawler
     */
    public GUICrawler() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Start Crawler");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUICrawler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUICrawler().setVisible(true);
            }
        });
    }

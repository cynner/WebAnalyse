...
public class WebArcReader_Old extends WebArcReader{
    ...
    public WebArcReader_Old(File ArcFile, String FixedCharset, boolean AnalyseWebContent) throws FileNotFoundException, IOException{
        this(ArcFile,FixedCharset);
        this.AnalyseWebContent = AnalyseWebContent;
    }
    
    public WebArcReader_Old(File ArcFile, boolean AnalyseCharset, boolean AnalyseWebContent) throws FileNotFoundException, IOException{
        this(ArcFile,null);
        this.AnalyseCharset = AnalyseCharset;
        this.AnalyseWebContent = AnalyseWebContent;
    }
    
    public WebArcReader_Old(File ArcFile, boolean AnalyseCharset) throws FileNotFoundException, IOException{
        this(ArcFile,null);
        this.AnalyseCharset = AnalyseCharset;
    }
    
    public WebArcReader_Old(File ArcFile, String FixedCharset) throws FileNotFoundException, IOException {
        super(ArcFile, FixedCharset);
        this.Record = new WebArcRecord_Old();
